...
class EnsembleStrategy(IStrategy):
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        """
        return dataframe
# Buy indicator for Simple strategy
    def simple_buy(self, dataframe):
        return (
    ...
    # Sell indicator for Simple Strategy
    def simple_sell(self, dataframe):
        return (
                (dataframe['rsi'] > 80)
               )
    # Buy indicator for Default Strategy
    def default_buy(self, dataframe):
        return (
    ...
    # Sell indicator for Default Strategy
    def default_sell(self, dataframe):
        return (
